...
namespace EmploymentSystemMvc
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            var employee = new EmployeeManagement(employeeStorage,leaveStorage,holidayStorage,attendanceStorage,concernStorage);
            services.AddSingleton<EmployeeManagement>(employee);
